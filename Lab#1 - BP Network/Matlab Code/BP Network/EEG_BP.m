function [ net, REF_PRED_FIX ] = EEG_BP( net )
...
REF_TRAIN = zeros(H, 18);
for i = 1 : H
    REF_TRAIN(i, TRAIN(i, 1)) = 1;
end
...
if nargin == 0
    net = newff(minmax(TRAIN), [500, 500, 1000, 18], { 'logsig' 'logsig' 'logsig' 'logsig' }, 'trainscg');
end
